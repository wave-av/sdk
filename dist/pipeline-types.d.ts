...
type StreamStatus = "idle" | "connecting" | "live" | "reconnecting" | "ending" | "ended" | "failed";
type StreamProtocol = "webrtc" | "srt" | "rtmp" | "hls" | "ndi" | "omt";
type StreamQuality = "source" | "4k" | "1080p" | "720p" | "480p" | "360p";
interface Stream extends Timestamps {
...
interface ListStreamsParams extends PaginationParams {
...
interface StreamRecording extends Timestamps {
...
export type { CreateStreamRequest, IngestEndpoint, ListStreamsParams, Stream, StreamEvent, StreamHealth, StreamProtocol, StreamQuality, StreamRecording, StreamStatus, UpdateStreamRequest, ViewerSession };
