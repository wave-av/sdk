 ...
 */
interface TelemetrySpanAttributes {
 ...
 */
declare function withTelemetry<T>(operationName: string, fn: () => Promise<T>, attributes?: Record<string, string | number | boolean>): Promise<T>;
/**
 * Synchronous version of withTelemetry for non-async operations.
 * Same zero-overhead behavior when disabled.
 */
declare function withTelemetrySync<T>(operationName: string, fn: () => T, attributes?: Record<string, string | number | boolean>): T;

export { type TelemetryConfig, type TelemetrySpanAttributes, initTelemetry, isTelemetryEnabled, resetTelemetry, withTelemetry, withTelemetrySync };
