...
type WaveRealtimeEventName = 'transcription.partial' | 'transcription.final' | 'caption.cue' | 'sentiment.tick' | 'clip.created' | 'stream.started' | 'stream.viewer_count' | 'stream.ended' | (string & {});
...
export type { PresenceMember, RealtimeChannelEvents, RealtimeConnectOptions, RealtimeFrame, WaveRealtimeEventName };
