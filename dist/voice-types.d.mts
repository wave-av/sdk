...
type VoiceModelType = 'standard' | 'neural' | 'cloned' | 'professional';
type VoiceGender = 'male' | 'female' | 'neutral';
type AudioFormat = 'mp3' | 'wav' | 'ogg' | 'flac' | 'pcm';
interface Voice extends Timestamps {
    id: string;
...
interface SynthesisResult extends Timestamps {
    id: string;
    organization_id: string;
    voice_id: string;
...
interface VoiceCloneJob extends Timestamps {
    id: string;
    organization_id: string;
    voice_id?: string;
...
interface ListVoicesParams extends PaginationParams {
    model_type?: VoiceModelType;
    gender?: VoiceGender;
    language?: string;
    is_public?: boolean;
...
export type { AudioFormat, CloneVoiceRequest, ListVoicesParams, SynthesisResult, SynthesizeRequest, Voice, VoiceCloneJob, VoiceGender, VoiceModelType, VoiceSettings };
